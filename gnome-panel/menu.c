...
GtkWidget *
create_panel_root_menu(GtkWidget *panel, gboolean tearoff)
{
	GtkWidget *menu;
...
void
add_menu_widget (Menu *menu, GSList *menudirl,
...
static Menu *
create_panel_menu (char *menudir, gboolean main_menu,
		   ...
		   int main_menu_flags)
{
	...
	menu = create_panel_menu (this_menu, main_menu,
